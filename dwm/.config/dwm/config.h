...
static const Key keys[] = {
    ...
    {Mod1Mask, XK_Tab, toggleAttachBelow, {0}},
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MODKEY | ShiftMask, XK_q, quit, {0}},
    {MODKEY | ControlMask | ShiftMask, XK_q, quit, {1}},
    {MODKEY, XK_F5, spawn, SHCMD("mpc prev && songinfo")},
    {MODKEY, XK_F6, spawn, SHCMD("mpc toggle && songinfo")},
    {MODKEY, XK_F7, spawn, SHCMD("mpc next && songinfo")},
    {0, XF86XK_AudioRaiseVolume, spawn, SHCMD("changeVolume 2%+")},
    {0, XF86XK_AudioLowerVolume, spawn, SHCMD("changeVolume 2%-")},
    {0, XF86XK_AudioMute, spawn, SHCMD("changeVolume toggle")},
    {0, XF86XK_MonBrightnessUp, spawn, SHCMD("changeBrightness 10%+")},
    {0, XF86XK_MonBrightnessDown, spawn, SHCMD("changeBrightness 10%-")},
    {0, XK_Print, spawn, SHCMD("screenshot")},
    {ShiftMask, XK_Print, spawn, SHCMD("scrotpick")},
